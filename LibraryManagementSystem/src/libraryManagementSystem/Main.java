	...
	public static void login() {
		...
		login_but.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				{
				  JOptionPane.showMessageDialog(null,"Please enter password "); //Display Dialog box with the massage
					...
					try
					{
						...
						String st = ("SELECT * FROM USERS WHERE USERNAME = '" +username+ "' AND PASSWORD= '"+password+"'"); //retrive username and password from users
	    ...
	    view_but.addActionListener(new ActionListener() { 
	        public void actionPerformed(ActionEvent e){
	            ...
	            try {
	                ...
	                DefaultTableModel model = (DefaultTableModel) book_list.getModel();
